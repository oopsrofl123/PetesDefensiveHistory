...
ns.AbilityDb = {
    ...
    ["MONK"] = {
		...
		},
        {
			...
			duration=15,
			duration_variable=ns.DURATION_FIXED,
			charges=2,   -- seems to be 2 at baseline
			cdr=false,
            IMPORTANT=true, BIG=false, EXTERNAL=false, RAID=false, RAIDINCOMBAT=false,
			targets=ns.TARGET_SELF,
            requireButtonPress=true,
    ...
    ["PALADIN"] = {
		...
		},
		{
			...
			charges=1,
			cdr=false,
            IMPORTANT=true, BIG=true, EXTERNAL=true, RAID=true, RAIDINCOMBAT=false,
			targets=ns.TARGET_ANY,
            requireButtonPress=true,
            requireDebuff=true,
		},
    ...
    ["ROGUE"] = {
        ...
        -- XXX: TODO: to differentiate from dance, blades doesn't apply any other auras in the same event, 
		{
            ...
            iconId=376022,
			cooldown=90,
			duration=20,   -- 16,  -- 4pc tier gives +4s. need a way to detect this, but assuming 4pc tier at this point will be correct more often than not
			duration_variable=ns.DURATION_FIXED,
			charges=1,
			cdr=false,
            IMPORTANT=true, BIG=false, EXTERNAL=false, RAID=false, RAIDINCOMBAT=false,
    ...
    ["SHAMAN"] = {
		...
		},
		{
            ...
            IMPORTANT=true, BIG=false, EXTERNAL=false, RAID=false, RAIDINCOMBAT=false,
			targets=ns.TARGET_SELF,
            requireButtonPress=true,  -- attached to a riptide cast
		},
		{
			name="Doom Winds",
            alias='D.Winds',
